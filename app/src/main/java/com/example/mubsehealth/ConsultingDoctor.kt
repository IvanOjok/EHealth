...
import com.example.mubsehealth.model.ConsultDoctorAdapter
...
class ConsultingDoctor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dbRef = FirebaseDatabase.getInstance().getReference("/doctors").addValueEventListener(object :
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val adapter = ConsultDoctorAdapter(this@ConsultingDoctor, p)
            ...
            override fun onCancelled(error: DatabaseError) {
                dialog.dismiss()
                Toast.makeText(this@ConsultingDoctor, "An $error occured", Toast.LENGTH_LONG).show()
            }
